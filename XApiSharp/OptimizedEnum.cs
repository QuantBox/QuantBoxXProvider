...
namespace Ideafixxxer.Generics
{
    ...
    /// <summary>
    /// XApiHelper class for enum types
    /// </summary>
    ...
    public static class Enum<T> where T : struct, IConvertible
    {
        ...
        {
            var b = Converter.TryParseInternal(value, ignoreCase, parseNumeric, out int ir);
        ...
        {
            var b = Converter.TryParseInternal(value, ignoreCase, true, out int ir);
            result = (T)Enum.ToObject(typeof(T), ir);
            return b;
        }
        ...
        {
            var b = Converter.TryParseInternal(value, false, true, out int ir);
            result = (T)Enum.ToObject(typeof(T), ir);
            return b;
        }
    }
