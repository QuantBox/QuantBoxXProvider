...
///查询用户当前支持的认证模式的回复
 typedef void (CALLBACK * Trader_OnRspUserAuthMethod)(CThostFtdcRspUserAuthMethodField *pRspUserAuthMethod,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///获取图形验证码请求的回复
 typedef void (CALLBACK * Trader_OnRspGenUserCaptcha)(CThostFtdcRspGenUserCaptchaField *pRspGenUserCaptcha,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///获取短信验证码请求的回复
 typedef void (CALLBACK * Trader_OnRspGenUserText)(CThostFtdcRspGenUserTextField *pRspGenUserText,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///报单录入请求响应
...
///期权自对冲录入请求响应
 typedef void (CALLBACK * Trader_OnRspOptionSelfCloseInsert)(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///期权自对冲操作请求响应
 typedef void (CALLBACK * Trader_OnRspOptionSelfCloseAction)(CThostFtdcInputOptionSelfCloseActionField *pInputOptionSelfCloseAction,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///申请组合录入请求响应
...
///请求查询做市商合约手续费率响应
 typedef void (CALLBACK * Trader_OnRspQryMMInstrumentCommissionRate)(CThostFtdcMMInstrumentCommissionRateField *pMMInstrumentCommissionRate,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///请求查询做市商期权合约手续费响应
 typedef void (CALLBACK * Trader_OnRspQryMMOptionInstrCommRate)(CThostFtdcMMOptionInstrCommRateField *pMMOptionInstrCommRate,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///请求查询报单手续费响应
 typedef void (CALLBACK * Trader_OnRspQryInstrumentOrderCommRate)(CThostFtdcInstrumentOrderCommRateField *pInstrumentOrderCommRate,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///请求查询资金账户响应
 typedef void (CALLBACK * Trader_OnRspQrySecAgentTradingAccount)(CThostFtdcTradingAccountField *pTradingAccount,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///请求查询二级代理商资金校验模式响应
 typedef void (CALLBACK * Trader_OnRspQrySecAgentCheckMode)(CThostFtdcSecAgentCheckModeField *pSecAgentCheckMode,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///请求查询二级代理商信息响应
 typedef void (CALLBACK * Trader_OnRspQrySecAgentTradeInfo)(CThostFtdcSecAgentTradeInfoField *pSecAgentTradeInfo,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///请求查询期权交易成本响应
...
///请求查询期权自对冲响应
 typedef void (CALLBACK * Trader_OnRspQryOptionSelfClose)(CThostFtdcOptionSelfCloseField *pOptionSelfClose,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///请求查询投资单元响应
 typedef void (CALLBACK * Trader_OnRspQryInvestUnit)(CThostFtdcInvestUnitField *pInvestUnit,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast);
///请求查询组合合约安全系数响应
...
///交易所公告通知
 typedef void (CALLBACK * Trader_OnRtnBulletin)(CThostFtdcBulletinField *pBulletin);
///交易通知
...
///期权自对冲通知
 typedef void (CALLBACK * Trader_OnRtnOptionSelfClose)(CThostFtdcOptionSelfCloseField *pOptionSelfClose);
///期权自对冲录入错误回报
 typedef void (CALLBACK * Trader_OnErrRtnOptionSelfCloseInsert)(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose,CThostFtdcRspInfoField *pRspInfo);
///期权自对冲操作错误回报
 typedef void (CALLBACK * Trader_OnErrRtnOptionSelfCloseAction)(CThostFtdcOptionSelfCloseActionField *pOptionSelfCloseAction,CThostFtdcRspInfoField *pRspInfo);
///申请组合通知
...
class CMySfitTrader : public CThostFtdcTraderSpi
{
    public:
        ...
        Trader_OnRspUserAuthMethod _OnRspUserAuthMethod{};
        Trader_OnRspGenUserCaptcha _OnRspGenUserCaptcha{};
        Trader_OnRspGenUserText _OnRspGenUserText{};
        ...
        Trader_OnRspOptionSelfCloseInsert _OnRspOptionSelfCloseInsert{};
        Trader_OnRspOptionSelfCloseAction _OnRspOptionSelfCloseAction{};
        ...
        Trader_OnRspQryMMInstrumentCommissionRate _OnRspQryMMInstrumentCommissionRate{};
        Trader_OnRspQryMMOptionInstrCommRate _OnRspQryMMOptionInstrCommRate{};
        Trader_OnRspQryInstrumentOrderCommRate _OnRspQryInstrumentOrderCommRate{};
        Trader_OnRspQrySecAgentTradingAccount _OnRspQrySecAgentTradingAccount{};
        Trader_OnRspQrySecAgentCheckMode _OnRspQrySecAgentCheckMode{};
        Trader_OnRspQrySecAgentTradeInfo _OnRspQrySecAgentTradeInfo{};
        ...
        Trader_OnRspQryOptionSelfClose _OnRspQryOptionSelfClose{};
        Trader_OnRspQryInvestUnit _OnRspQryInvestUnit{};
        ...
        Trader_OnRtnBulletin _OnRtnBulletin{};
        ...
        Trader_OnRtnOptionSelfClose _OnRtnOptionSelfClose{};
        Trader_OnErrRtnOptionSelfCloseInsert _OnErrRtnOptionSelfCloseInsert{};
        Trader_OnErrRtnOptionSelfCloseAction _OnErrRtnOptionSelfCloseAction{};
...
///@param nTimeLapse 距离上次接收报文的时间
 ...
 void OnRspUserAuthMethod(CThostFtdcRspUserAuthMethodField *pRspUserAuthMethod,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspUserAuthMethod(pRspUserAuthMethod,pRspInfo,nRequestID,bIsLast);
        }
        ///获取图形验证码请求的回复
 void OnRspGenUserCaptcha(CThostFtdcRspGenUserCaptchaField *pRspGenUserCaptcha,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspGenUserCaptcha(pRspGenUserCaptcha,pRspInfo,nRequestID,bIsLast);
        }
        ///获取短信验证码请求的回复
 void OnRspGenUserText(CThostFtdcRspGenUserTextField *pRspGenUserText,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspGenUserText(pRspGenUserText,pRspInfo,nRequestID,bIsLast);
        }
        ///报单录入请求响应
 ...
 void OnRspOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspOptionSelfCloseInsert(pInputOptionSelfClose,pRspInfo,nRequestID,bIsLast);
        }
        ///期权自对冲操作请求响应
 void OnRspOptionSelfCloseAction(CThostFtdcInputOptionSelfCloseActionField *pInputOptionSelfCloseAction,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspOptionSelfCloseAction(pInputOptionSelfCloseAction,pRspInfo,nRequestID,bIsLast);
        }
        ///申请组合录入请求响应
 ...
 void OnRspQryMMInstrumentCommissionRate(CThostFtdcMMInstrumentCommissionRateField *pMMInstrumentCommissionRate,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspQryMMInstrumentCommissionRate(pMMInstrumentCommissionRate,pRspInfo,nRequestID,bIsLast);
        }
        ///请求查询做市商期权合约手续费响应
 void OnRspQryMMOptionInstrCommRate(CThostFtdcMMOptionInstrCommRateField *pMMOptionInstrCommRate,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspQryMMOptionInstrCommRate(pMMOptionInstrCommRate,pRspInfo,nRequestID,bIsLast);
        }
        ///请求查询报单手续费响应
 void OnRspQryInstrumentOrderCommRate(CThostFtdcInstrumentOrderCommRateField *pInstrumentOrderCommRate,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspQryInstrumentOrderCommRate(pInstrumentOrderCommRate,pRspInfo,nRequestID,bIsLast);
        }
        ///请求查询资金账户响应
 void OnRspQrySecAgentTradingAccount(CThostFtdcTradingAccountField *pTradingAccount,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspQrySecAgentTradingAccount(pTradingAccount,pRspInfo,nRequestID,bIsLast);
        }
        ///请求查询二级代理商资金校验模式响应
 void OnRspQrySecAgentCheckMode(CThostFtdcSecAgentCheckModeField *pSecAgentCheckMode,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspQrySecAgentCheckMode(pSecAgentCheckMode,pRspInfo,nRequestID,bIsLast);
        }
        ///请求查询二级代理商信息响应
 void OnRspQrySecAgentTradeInfo(CThostFtdcSecAgentTradeInfoField *pSecAgentTradeInfo,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspQrySecAgentTradeInfo(pSecAgentTradeInfo,pRspInfo,nRequestID,bIsLast);
        }
        ///请求查询期权交易成本响应
 ...
 void OnRspQryOptionSelfClose(CThostFtdcOptionSelfCloseField *pOptionSelfClose,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspQryOptionSelfClose(pOptionSelfClose,pRspInfo,nRequestID,bIsLast);
        }
        ///请求查询投资单元响应
 void OnRspQryInvestUnit(CThostFtdcInvestUnitField *pInvestUnit,CThostFtdcRspInfoField *pRspInfo,int nRequestID,bool bIsLast) override
        {
            _OnRspQryInvestUnit(pInvestUnit,pRspInfo,nRequestID,bIsLast);
        }
        ///请求查询组合合约安全系数响应
 ...
 void OnRtnOptionSelfClose(CThostFtdcOptionSelfCloseField *pOptionSelfClose) override
        {
            _OnRtnOptionSelfClose(pOptionSelfClose);
        }
        ///期权自对冲录入错误回报
 void OnErrRtnOptionSelfCloseInsert(CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose,CThostFtdcRspInfoField *pRspInfo) override
        {
            _OnErrRtnOptionSelfCloseInsert(pInputOptionSelfClose,pRspInfo);
        }
        ///期权自对冲操作错误回报
 void OnErrRtnOptionSelfCloseAction(CThostFtdcOptionSelfCloseActionField *pOptionSelfCloseAction,CThostFtdcRspInfoField *pRspInfo) override
        {
            _OnErrRtnOptionSelfCloseAction(pOptionSelfCloseAction,pRspInfo);
        }
        ///申请组合通知
...
{
    const auto api = static_cast<CMySfitTrader*>(instance);
...
DLL void CALLBACK Trader_Set_OnRspUserAuthMethod(void* instance, Trader_OnRspUserAuthMethod callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspUserAuthMethod = callback;
}
DLL void CALLBACK Trader_Set_OnRspGenUserCaptcha(void* instance, Trader_OnRspGenUserCaptcha callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspGenUserCaptcha = callback;
}
DLL void CALLBACK Trader_Set_OnRspGenUserText(void* instance, Trader_OnRspGenUserText callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspGenUserText = callback;
}
...
DLL void CALLBACK Trader_Set_OnRspOptionSelfCloseInsert(void* instance, Trader_OnRspOptionSelfCloseInsert callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspOptionSelfCloseInsert = callback;
}
DLL void CALLBACK Trader_Set_OnRspOptionSelfCloseAction(void* instance, Trader_OnRspOptionSelfCloseAction callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspOptionSelfCloseAction = callback;
}
...
DLL void CALLBACK Trader_Set_OnRspQryMMInstrumentCommissionRate(void* instance, Trader_OnRspQryMMInstrumentCommissionRate callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspQryMMInstrumentCommissionRate = callback;
}
DLL void CALLBACK Trader_Set_OnRspQryMMOptionInstrCommRate(void* instance, Trader_OnRspQryMMOptionInstrCommRate callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspQryMMOptionInstrCommRate = callback;
}
DLL void CALLBACK Trader_Set_OnRspQryInstrumentOrderCommRate(void* instance, Trader_OnRspQryInstrumentOrderCommRate callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspQryInstrumentOrderCommRate = callback;
}
DLL void CALLBACK Trader_Set_OnRspQrySecAgentTradingAccount(void* instance, Trader_OnRspQrySecAgentTradingAccount callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspQrySecAgentTradingAccount = callback;
}
DLL void CALLBACK Trader_Set_OnRspQrySecAgentCheckMode(void* instance, Trader_OnRspQrySecAgentCheckMode callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspQrySecAgentCheckMode = callback;
}
DLL void CALLBACK Trader_Set_OnRspQrySecAgentTradeInfo(void* instance, Trader_OnRspQrySecAgentTradeInfo callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspQrySecAgentTradeInfo = callback;
}
...
DLL void CALLBACK Trader_Set_OnRspQryOptionSelfClose(void* instance, Trader_OnRspQryOptionSelfClose callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspQryOptionSelfClose = callback;
}
DLL void CALLBACK Trader_Set_OnRspQryInvestUnit(void* instance, Trader_OnRspQryInvestUnit callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRspQryInvestUnit = callback;
}
...
DLL void CALLBACK Trader_Set_OnRtnBulletin(void* instance, Trader_OnRtnBulletin callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRtnBulletin = callback;
}
...
DLL void CALLBACK Trader_Set_OnRtnOptionSelfClose(void* instance, Trader_OnRtnOptionSelfClose callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnRtnOptionSelfClose = callback;
}
DLL void CALLBACK Trader_Set_OnErrRtnOptionSelfCloseInsert(void* instance, Trader_OnErrRtnOptionSelfCloseInsert callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnErrRtnOptionSelfCloseInsert = callback;
}
DLL void CALLBACK Trader_Set_OnErrRtnOptionSelfCloseAction(void* instance, Trader_OnErrRtnOptionSelfCloseAction callback)
{
    const auto api = static_cast<CMySfitTrader*>(instance);
    api->_OnErrRtnOptionSelfCloseAction = callback;
}
...
DLL void CALLBACK Trader_RegisterFensUserInfo(void* instance, CThostFtdcFensUserInfoField *pFensUserInfo)
{
    auto api = static_cast<CMySfitTrader*>(instance);
...
DLL int CALLBACK Trader_RegisterUserSystemInfo(void* instance,CThostFtdcUserSystemInfoField *pUserSystemInfo)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->RegisterUserSystemInfo(pUserSystemInfo);
    }
    ///上报用户终端信息，用于中继服务器操作员登录模式
///操作员登录后，可以多次调用该接口上报客户信息
DLL int CALLBACK Trader_SubmitUserSystemInfo(void* instance,CThostFtdcUserSystemInfoField *pUserSystemInfo)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->SubmitUserSystemInfo(pUserSystemInfo);
    }
    ///用户登录请求
...
DLL int CALLBACK Trader_ReqTradingAccountPasswordUpdate(void* instance,CThostFtdcTradingAccountPasswordUpdateField *pTradingAccountPasswordUpdate,int nRequestID)
    ...
    ///查询用户当前支持的认证模式
DLL int CALLBACK Trader_ReqUserAuthMethod(void* instance,CThostFtdcReqUserAuthMethodField *pReqUserAuthMethod,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqUserAuthMethod(pReqUserAuthMethod,nRequestID);
    }
    ///用户发出获取图形验证码请求
DLL int CALLBACK Trader_ReqGenUserCaptcha(void* instance,CThostFtdcReqGenUserCaptchaField *pReqGenUserCaptcha,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqGenUserCaptcha(pReqGenUserCaptcha,nRequestID);
    }
    ///用户发出获取短信验证码请求
DLL int CALLBACK Trader_ReqGenUserText(void* instance,CThostFtdcReqGenUserTextField *pReqGenUserText,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqGenUserText(pReqGenUserText,nRequestID);
    }
    ///用户发出带有图片验证码的登陆请求
DLL int CALLBACK Trader_ReqUserLoginWithCaptcha(void* instance,CThostFtdcReqUserLoginWithCaptchaField *pReqUserLoginWithCaptcha,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqUserLoginWithCaptcha(pReqUserLoginWithCaptcha,nRequestID);
    }
    ///用户发出带有短信验证码的登陆请求
DLL int CALLBACK Trader_ReqUserLoginWithText(void* instance,CThostFtdcReqUserLoginWithTextField *pReqUserLoginWithText,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqUserLoginWithText(pReqUserLoginWithText,nRequestID);
    }
    ///用户发出带有动态口令的登陆请求
DLL int CALLBACK Trader_ReqUserLoginWithOTP(void* instance,CThostFtdcReqUserLoginWithOTPField *pReqUserLoginWithOTP,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqUserLoginWithOTP(pReqUserLoginWithOTP,nRequestID);
    }
    ///报单录入请求
...
DLL int CALLBACK Trader_ReqBatchOrderAction(void* instance,CThostFtdcInputBatchOrderActionField *pInputBatchOrderAction,int nRequestID)
    ...
    ///期权自对冲录入请求
DLL int CALLBACK Trader_ReqOptionSelfCloseInsert(void* instance,CThostFtdcInputOptionSelfCloseField *pInputOptionSelfClose,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqOptionSelfCloseInsert(pInputOptionSelfClose,nRequestID);
    }
    ///期权自对冲操作请求
DLL int CALLBACK Trader_ReqOptionSelfCloseAction(void* instance,CThostFtdcInputOptionSelfCloseActionField *pInputOptionSelfCloseAction,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqOptionSelfCloseAction(pInputOptionSelfCloseAction,nRequestID);
    }
    ///申请组合录入请求
...
DLL int CALLBACK Trader_ReqQryProductGroup(void* instance,CThostFtdcQryProductGroupField *pQryProductGroup,int nRequestID)
    ...
    ///请求查询做市商合约手续费率
DLL int CALLBACK Trader_ReqQryMMInstrumentCommissionRate(void* instance,CThostFtdcQryMMInstrumentCommissionRateField *pQryMMInstrumentCommissionRate,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqQryMMInstrumentCommissionRate(pQryMMInstrumentCommissionRate,nRequestID);
    }
    ///请求查询做市商期权合约手续费
DLL int CALLBACK Trader_ReqQryMMOptionInstrCommRate(void* instance,CThostFtdcQryMMOptionInstrCommRateField *pQryMMOptionInstrCommRate,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqQryMMOptionInstrCommRate(pQryMMOptionInstrCommRate,nRequestID);
    }
    ///请求查询报单手续费
DLL int CALLBACK Trader_ReqQryInstrumentOrderCommRate(void* instance,CThostFtdcQryInstrumentOrderCommRateField *pQryInstrumentOrderCommRate,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqQryInstrumentOrderCommRate(pQryInstrumentOrderCommRate,nRequestID);
    }
    ///请求查询资金账户
DLL int CALLBACK Trader_ReqQrySecAgentTradingAccount(void* instance,CThostFtdcQryTradingAccountField *pQryTradingAccount,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqQrySecAgentTradingAccount(pQryTradingAccount,nRequestID);
    }
    ///请求查询二级代理商资金校验模式
DLL int CALLBACK Trader_ReqQrySecAgentCheckMode(void* instance,CThostFtdcQrySecAgentCheckModeField *pQrySecAgentCheckMode,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqQrySecAgentCheckMode(pQrySecAgentCheckMode,nRequestID);
    }
    ///请求查询二级代理商信息
DLL int CALLBACK Trader_ReqQrySecAgentTradeInfo(void* instance,CThostFtdcQrySecAgentTradeInfoField *pQrySecAgentTradeInfo,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqQrySecAgentTradeInfo(pQrySecAgentTradeInfo,nRequestID);
    }
    ///请求查询期权交易成本
...
DLL int CALLBACK Trader_ReqQryQuote(void* instance,CThostFtdcQryQuoteField *pQryQuote,int nRequestID)
    ...
    ///请求查询期权自对冲
DLL int CALLBACK Trader_ReqQryOptionSelfClose(void* instance,CThostFtdcQryOptionSelfCloseField *pQryOptionSelfClose,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqQryOptionSelfClose(pQryOptionSelfClose,nRequestID);
    }
    ///请求查询投资单元
DLL int CALLBACK Trader_ReqQryInvestUnit(void* instance,CThostFtdcQryInvestUnitField *pQryInvestUnit,int nRequestID)
    {
        const auto api = static_cast<CMySfitTrader*>(instance);
        return api->native->ReqQryInvestUnit(pQryInvestUnit,nRequestID);
    }
    ///请求查询组合合约安全系数
