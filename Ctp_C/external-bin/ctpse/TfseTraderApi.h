...
#if !defined(TF_TRADERAPI_H)
#define TF_TRADERAPI_H
...
class TRADER_API_EXPORT CTfTraderApi
{
public:
	///创建TraderApi
	///@param pszFlowPath 存贮订阅信息文件的目录，默认为当前目录
	///@return 创建出的UserApi
	static CTfTraderApi *CreateTfTraderApi(const char *pszFlowPath = "");
	...
	virtual void RegisterSpi(CTfTraderSpi *pSpi) = 0;
