...
namespace QuantBox.Sfit.Api
{
    public class CtpTraderApi : CtpTraderSpi, ICtpRequestHandler
    {
        ...
        private void InitHandlerList()
        {
            ...
            _handerList[CtpRequestType.ReqUserLoginWithCaptcha] = DoReqUserLoginWithCaptcha;
            _handerList[CtpRequestType.ReqUserLoginWithText] = DoReqUserLoginWithText;
            _handerList[CtpRequestType.ReqUserLoginWithOTP] = DoReqUserLoginWithOTP;
            ...
            _handerList[CtpRequestType.ReqOptionSelfCloseInsert] = DoReqOptionSelfCloseInsert;
            _handerList[CtpRequestType.ReqOptionSelfCloseAction] = DoReqOptionSelfCloseAction;
            ...
            _handerList[CtpRequestType.ReqQryMMInstrumentCommissionRate] = DoReqQryMMInstrumentCommissionRate;
            _handerList[CtpRequestType.ReqQryMMOptionInstrCommRate] = DoReqQryMMOptionInstrCommRate;
            _handerList[CtpRequestType.ReqQryInstrumentOrderCommRate] = DoReqQryInstrumentOrderCommRate;
            _handerList[CtpRequestType.ReqQrySecAgentTradingAccount] = DoReqQrySecAgentTradingAccount;
            _handerList[CtpRequestType.ReqQrySecAgentCheckMode] = DoReqQrySecAgentCheckMode;
            _handerList[CtpRequestType.ReqQrySecAgentTradeInfo] = DoReqQrySecAgentTradeInfo;
            ...
            _handerList[CtpRequestType.ReqQryOptionSelfClose] = DoReqQryOptionSelfClose;
            _handerList[CtpRequestType.ReqQryInvestUnit] = DoReqQryInvestUnit;
        ...
        private CtpTraderNative.OnRspUserAuthMethod _cbOnRspUserAuthMethod;
        private CtpTraderNative.OnRspGenUserCaptcha _cbOnRspGenUserCaptcha;
        private CtpTraderNative.OnRspGenUserText _cbOnRspGenUserText;
        ...
        private CtpTraderNative.OnRspOptionSelfCloseInsert _cbOnRspOptionSelfCloseInsert;
        private CtpTraderNative.OnRspOptionSelfCloseAction _cbOnRspOptionSelfCloseAction;
        ...
        private CtpTraderNative.OnRspQryMMInstrumentCommissionRate _cbOnRspQryMMInstrumentCommissionRate;
        private CtpTraderNative.OnRspQryMMOptionInstrCommRate _cbOnRspQryMMOptionInstrCommRate;
        private CtpTraderNative.OnRspQryInstrumentOrderCommRate _cbOnRspQryInstrumentOrderCommRate;
        private CtpTraderNative.OnRspQrySecAgentTradingAccount _cbOnRspQrySecAgentTradingAccount;
        private CtpTraderNative.OnRspQrySecAgentCheckMode _cbOnRspQrySecAgentCheckMode;
        private CtpTraderNative.OnRspQrySecAgentTradeInfo _cbOnRspQrySecAgentTradeInfo;
        ...
        private CtpTraderNative.OnRspQryOptionSelfClose _cbOnRspQryOptionSelfClose;
        private CtpTraderNative.OnRspQryInvestUnit _cbOnRspQryInvestUnit;
        ...
        private CtpTraderNative.OnRtnBulletin _cbOnRtnBulletin;
        ...
        private CtpTraderNative.OnRtnOptionSelfClose _cbOnRtnOptionSelfClose;
        private CtpTraderNative.OnErrRtnOptionSelfCloseInsert _cbOnErrRtnOptionSelfCloseInsert;
        private CtpTraderNative.OnErrRtnOptionSelfCloseAction _cbOnErrRtnOptionSelfCloseAction;
        ...
        private void InitNativeCallback()
        {
            ...
            _cbOnRspUserAuthMethod = NativeOnRspUserAuthMethod; 
            CtpTraderNative.SetOnRspUserAuthMethod(_instance, _cbOnRspUserAuthMethod);
            _cbOnRspGenUserCaptcha = NativeOnRspGenUserCaptcha; 
            CtpTraderNative.SetOnRspGenUserCaptcha(_instance, _cbOnRspGenUserCaptcha);
            _cbOnRspGenUserText = NativeOnRspGenUserText; 
            CtpTraderNative.SetOnRspGenUserText(_instance, _cbOnRspGenUserText);
            ...
            _cbOnRspOptionSelfCloseInsert = NativeOnRspOptionSelfCloseInsert; 
            CtpTraderNative.SetOnRspOptionSelfCloseInsert(_instance, _cbOnRspOptionSelfCloseInsert);
            _cbOnRspOptionSelfCloseAction = NativeOnRspOptionSelfCloseAction; 
            CtpTraderNative.SetOnRspOptionSelfCloseAction(_instance, _cbOnRspOptionSelfCloseAction);
            ...
            _cbOnRspQryMMInstrumentCommissionRate = NativeOnRspQryMMInstrumentCommissionRate; 
            CtpTraderNative.SetOnRspQryMMInstrumentCommissionRate(_instance, _cbOnRspQryMMInstrumentCommissionRate);
            _cbOnRspQryMMOptionInstrCommRate = NativeOnRspQryMMOptionInstrCommRate; 
            CtpTraderNative.SetOnRspQryMMOptionInstrCommRate(_instance, _cbOnRspQryMMOptionInstrCommRate);
            _cbOnRspQryInstrumentOrderCommRate = NativeOnRspQryInstrumentOrderCommRate; 
            CtpTraderNative.SetOnRspQryInstrumentOrderCommRate(_instance, _cbOnRspQryInstrumentOrderCommRate);
            _cbOnRspQrySecAgentTradingAccount = NativeOnRspQrySecAgentTradingAccount; 
            CtpTraderNative.SetOnRspQrySecAgentTradingAccount(_instance, _cbOnRspQrySecAgentTradingAccount);
            _cbOnRspQrySecAgentCheckMode = NativeOnRspQrySecAgentCheckMode; 
            CtpTraderNative.SetOnRspQrySecAgentCheckMode(_instance, _cbOnRspQrySecAgentCheckMode);
            _cbOnRspQrySecAgentTradeInfo = NativeOnRspQrySecAgentTradeInfo; 
            CtpTraderNative.SetOnRspQrySecAgentTradeInfo(_instance, _cbOnRspQrySecAgentTradeInfo);
            ...
            _cbOnRspQryOptionSelfClose = NativeOnRspQryOptionSelfClose; 
            CtpTraderNative.SetOnRspQryOptionSelfClose(_instance, _cbOnRspQryOptionSelfClose);
            _cbOnRspQryInvestUnit = NativeOnRspQryInvestUnit; 
            CtpTraderNative.SetOnRspQryInvestUnit(_instance, _cbOnRspQryInvestUnit);
            ...
            _cbOnRtnBulletin = NativeOnRtnBulletin; 
            CtpTraderNative.SetOnRtnBulletin(_instance, _cbOnRtnBulletin);
            ...
            _cbOnRtnOptionSelfClose = NativeOnRtnOptionSelfClose; 
            CtpTraderNative.SetOnRtnOptionSelfClose(_instance, _cbOnRtnOptionSelfClose);
            _cbOnErrRtnOptionSelfCloseInsert = NativeOnErrRtnOptionSelfCloseInsert; 
            CtpTraderNative.SetOnErrRtnOptionSelfCloseInsert(_instance, _cbOnErrRtnOptionSelfCloseInsert);
            _cbOnErrRtnOptionSelfCloseAction = NativeOnErrRtnOptionSelfCloseAction; 
            CtpTraderNative.SetOnErrRtnOptionSelfCloseAction(_instance, _cbOnErrRtnOptionSelfCloseAction);
...
ProcessResponse(ref rsp);
        ...
        ///查询用户当前支持的认证模式的回复
 private void NativeOnRspUserAuthMethod(CtpRspUserAuthMethod rspUserAuthMethod,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspUserAuthMethod;
rsp.Item1 = new CtpAny(rspUserAuthMethod);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
        ...
        ///获取图形验证码请求的回复
 private void NativeOnRspGenUserCaptcha(CtpRspGenUserCaptcha rspGenUserCaptcha,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspGenUserCaptcha;
rsp.Item1 = new CtpAny(rspGenUserCaptcha);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
        ...
        ///获取短信验证码请求的回复
 private void NativeOnRspGenUserText(CtpRspGenUserText rspGenUserText,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspGenUserText;
rsp.Item1 = new CtpAny(rspGenUserText);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
...
ProcessResponse(ref rsp);
        ...
        ///期权自对冲录入请求响应
 private void NativeOnRspOptionSelfCloseInsert(CtpInputOptionSelfClose inputOptionSelfClose,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspOptionSelfCloseInsert;
rsp.Item1 = new CtpAny(inputOptionSelfClose);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
        ...
        ///期权自对冲操作请求响应
 private void NativeOnRspOptionSelfCloseAction(CtpInputOptionSelfCloseAction inputOptionSelfCloseAction,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspOptionSelfCloseAction;
rsp.Item1 = new CtpAny(inputOptionSelfCloseAction);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
...
ProcessResponse(ref rsp);
        ...
        ///请求查询做市商合约手续费率响应
 private void NativeOnRspQryMMInstrumentCommissionRate(CtpMMInstrumentCommissionRate mMInstrumentCommissionRate,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspQryMMInstrumentCommissionRate;
rsp.Item1 = new CtpAny(mMInstrumentCommissionRate);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
        ...
        ///请求查询做市商期权合约手续费响应
 private void NativeOnRspQryMMOptionInstrCommRate(CtpMMOptionInstrCommRate mMOptionInstrCommRate,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspQryMMOptionInstrCommRate;
rsp.Item1 = new CtpAny(mMOptionInstrCommRate);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
        ...
        ///请求查询报单手续费响应
 private void NativeOnRspQryInstrumentOrderCommRate(CtpInstrumentOrderCommRate instrumentOrderCommRate,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspQryInstrumentOrderCommRate;
rsp.Item1 = new CtpAny(instrumentOrderCommRate);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
        ...
        ///请求查询资金账户响应
 private void NativeOnRspQrySecAgentTradingAccount(CtpTradingAccount tradingAccount,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspQrySecAgentTradingAccount;
rsp.Item1 = new CtpAny(tradingAccount);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
        ...
        ///请求查询二级代理商资金校验模式响应
 private void NativeOnRspQrySecAgentCheckMode(CtpSecAgentCheckMode secAgentCheckMode,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspQrySecAgentCheckMode;
rsp.Item1 = new CtpAny(secAgentCheckMode);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
        ...
        ///请求查询二级代理商信息响应
 private void NativeOnRspQrySecAgentTradeInfo(CtpSecAgentTradeInfo secAgentTradeInfo,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspQrySecAgentTradeInfo;
rsp.Item1 = new CtpAny(secAgentTradeInfo);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
...
ProcessResponse(ref rsp);
        ...
        ///请求查询期权自对冲响应
 private void NativeOnRspQryOptionSelfClose(CtpOptionSelfClose optionSelfClose,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspQryOptionSelfClose;
rsp.Item1 = new CtpAny(optionSelfClose);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
        ...
        ///请求查询投资单元响应
 private void NativeOnRspQryInvestUnit(CtpInvestUnit investUnit,CtpRspInfo rspInfo,int requestId,bool isLast)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRspQryInvestUnit;
rsp.Item1 = new CtpAny(investUnit);
rsp.Item2 = rspInfo;
rsp.RequestID = requestId;
rsp.IsLast = isLast;
ProcessResponse(ref rsp);
...
ProcessResponse(ref rsp);
        ...
        ///交易所公告通知
 private void NativeOnRtnBulletin(CtpBulletin bulletin)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRtnBulletin;
rsp.Item1 = new CtpAny(bulletin);
ProcessResponse(ref rsp);
        }
...
ProcessResponse(ref rsp);
        ...
        ///期权自对冲通知
 private void NativeOnRtnOptionSelfClose(CtpOptionSelfClose optionSelfClose)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnRtnOptionSelfClose;
rsp.Item1 = new CtpAny(optionSelfClose);
ProcessResponse(ref rsp);
        }
        
        ///期权自对冲录入错误回报
 private void NativeOnErrRtnOptionSelfCloseInsert(CtpInputOptionSelfClose inputOptionSelfClose,CtpRspInfo rspInfo)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnErrRtnOptionSelfCloseInsert;
rsp.Item1 = new CtpAny(inputOptionSelfClose);
rsp.Item2 = rspInfo;
ProcessResponse(ref rsp);
        }
        ...
        ///期权自对冲操作错误回报
 private void NativeOnErrRtnOptionSelfCloseAction(CtpOptionSelfCloseAction optionSelfCloseAction,CtpRspInfo rspInfo)
        {
            var rsp = new CtpResponse();
            rsp.TypeId = CtpResponseType.OnErrRtnOptionSelfCloseAction;
rsp.Item1 = new CtpAny(optionSelfCloseAction);
rsp.Item2 = rspInfo;
ProcessResponse(ref rsp);
        }
...
return CtpTraderNative.ReqUserPasswordUpdate2(_instance, data, req.RequestID);
        ...
        {
            var data = req.Args.AsReqUserAuthMethod;
return CtpTraderNative.ReqUserAuthMethod(_instance, data, req.RequestID);
        }
        
        private int DoReqGenUserCaptcha(ref CtpRequest req)
        {
            var data = req.Args.AsReqGenUserCaptcha;
return CtpTraderNative.ReqGenUserCaptcha(_instance, data, req.RequestID);
        }
        
        private int DoReqGenUserText(ref CtpRequest req)
        {
            var data = req.Args.AsReqGenUserText;
return CtpTraderNative.ReqGenUserText(_instance, data, req.RequestID);
        }
        
        private int DoReqUserLoginWithCaptcha(ref CtpRequest req)
        {
            var data = req.Args.AsReqUserLoginWithCaptcha;
return CtpTraderNative.ReqUserLoginWithCaptcha(_instance, data, req.RequestID);
        }
        
        private int DoReqUserLoginWithText(ref CtpRequest req)
        {
            var data = req.Args.AsReqUserLoginWithText;
return CtpTraderNative.ReqUserLoginWithText(_instance, data, req.RequestID);
        }
        
        private int DoReqUserLoginWithOTP(ref CtpRequest req)
        {
            var data = req.Args.AsReqUserLoginWithOTP;
return CtpTraderNative.ReqUserLoginWithOTP(_instance, data, req.RequestID);
        }
...
return CtpTraderNative.ReqBatchOrderAction(_instance, data, req.RequestID);
        ...
        private int DoReqOptionSelfCloseInsert(ref CtpRequest req)
        {
            var data = req.Args.AsInputOptionSelfClose;
return CtpTraderNative.ReqOptionSelfCloseInsert(_instance, data, req.RequestID);
        }
        
        private int DoReqOptionSelfCloseAction(ref CtpRequest req)
        {
            var data = req.Args.AsInputOptionSelfCloseAction;
return CtpTraderNative.ReqOptionSelfCloseAction(_instance, data, req.RequestID);
        }
...
return CtpTraderNative.ReqQryProductGroup(_instance, data, req.RequestID);
        ...
        private int DoReqQryMMInstrumentCommissionRate(ref CtpRequest req)
        {
            var data = req.Args.AsQryMMInstrumentCommissionRate;
return CtpTraderNative.ReqQryMMInstrumentCommissionRate(_instance, data, req.RequestID);
        }
        
        private int DoReqQryMMOptionInstrCommRate(ref CtpRequest req)
        {
            var data = req.Args.AsQryMMOptionInstrCommRate;
return CtpTraderNative.ReqQryMMOptionInstrCommRate(_instance, data, req.RequestID);
        }
        
        private int DoReqQryInstrumentOrderCommRate(ref CtpRequest req)
        {
            var data = req.Args.AsQryInstrumentOrderCommRate;
return CtpTraderNative.ReqQryInstrumentOrderCommRate(_instance, data, req.RequestID);
        }
        
        private int DoReqQrySecAgentTradingAccount(ref CtpRequest req)
        {
            var data = req.Args.AsQryTradingAccount;
return CtpTraderNative.ReqQrySecAgentTradingAccount(_instance, data, req.RequestID);
        }
        
        private int DoReqQrySecAgentCheckMode(ref CtpRequest req)
        {
            var data = req.Args.AsQrySecAgentCheckMode;
return CtpTraderNative.ReqQrySecAgentCheckMode(_instance, data, req.RequestID);
        }
        
        private int DoReqQrySecAgentTradeInfo(ref CtpRequest req)
        {
            var data = req.Args.AsQrySecAgentTradeInfo;
return CtpTraderNative.ReqQrySecAgentTradeInfo(_instance, data, req.RequestID);
        }
...
return CtpTraderNative.ReqQryQuote(_instance, data, req.RequestID);
        ...
        private int DoReqQryOptionSelfClose(ref CtpRequest req)
        {
            var data = req.Args.AsQryOptionSelfClose;
return CtpTraderNative.ReqQryOptionSelfClose(_instance, data, req.RequestID);
        }
        
        private int DoReqQryInvestUnit(ref CtpRequest req)
        {
            var data = req.Args.AsQryInvestUnit;
return CtpTraderNative.ReqQryInvestUnit(_instance, data, req.RequestID);
        }
...
return CtpTraderNative.ReqQueryBankAccountMoneyByFuture(_instance, data, req.RequestID);
        ...
        {
            CtpTraderNative.RegisterFensUserInfo(_instance, fensUserInfo);
        }
        ///订阅私有流。
...
public int ReqUserPasswordUpdate2(CtpUserPasswordUpdate userPasswordUpdate,int requestId)
        ...
        ///查询用户当前支持的认证模式
public int ReqUserAuthMethod(CtpReqUserAuthMethod reqUserAuthMethod,int requestId)
        {
            return CtpTraderNative.ReqUserAuthMethod(_instance, reqUserAuthMethod, requestId);
        }

        ///用户发出获取图形验证码请求
public int ReqGenUserCaptcha(CtpReqGenUserCaptcha reqGenUserCaptcha,int requestId)
        {
            return CtpTraderNative.ReqGenUserCaptcha(_instance, reqGenUserCaptcha, requestId);
        }

        ///用户发出获取短信验证码请求
public int ReqGenUserText(CtpReqGenUserText reqGenUserText,int requestId)
        {
            return CtpTraderNative.ReqGenUserText(_instance, reqGenUserText, requestId);
        }

        ///用户发出带有图片验证码的登陆请求
public int ReqUserLoginWithCaptcha(CtpReqUserLoginWithCaptcha reqUserLoginWithCaptcha,int requestId)
        {
            return CtpTraderNative.ReqUserLoginWithCaptcha(_instance, reqUserLoginWithCaptcha, requestId);
        }

        ///用户发出带有短信验证码的登陆请求
public int ReqUserLoginWithText(CtpReqUserLoginWithText reqUserLoginWithText,int requestId)
        {
            return CtpTraderNative.ReqUserLoginWithText(_instance, reqUserLoginWithText, requestId);
        }

        ///用户发出带有动态口令的登陆请求
public int ReqUserLoginWithOTP(CtpReqUserLoginWithOTP reqUserLoginWithOTP,int requestId)
        {
            return CtpTraderNative.ReqUserLoginWithOTP(_instance, reqUserLoginWithOTP, requestId);
        }
...
public int ReqBatchOrderAction(CtpInputBatchOrderAction inputBatchOrderAction,int requestId)
        ...
        ///期权自对冲录入请求
public int ReqOptionSelfCloseInsert(CtpInputOptionSelfClose inputOptionSelfClose,int requestId)
        {
            return CtpTraderNative.ReqOptionSelfCloseInsert(_instance, inputOptionSelfClose, requestId);
        }

        ///期权自对冲操作请求
public int ReqOptionSelfCloseAction(CtpInputOptionSelfCloseAction inputOptionSelfCloseAction,int requestId)
        {
            return CtpTraderNative.ReqOptionSelfCloseAction(_instance, inputOptionSelfCloseAction, requestId);
        }
...
public int ReqQryProductGroup(CtpQryProductGroup qryProductGroup,int requestId)
        ...
        ///请求查询做市商合约手续费率
public int ReqQryMMInstrumentCommissionRate(CtpQryMMInstrumentCommissionRate qryMMInstrumentCommissionRate,int requestId)
        {
            return CtpTraderNative.ReqQryMMInstrumentCommissionRate(_instance, qryMMInstrumentCommissionRate, requestId);
        }

        ///请求查询做市商期权合约手续费
public int ReqQryMMOptionInstrCommRate(CtpQryMMOptionInstrCommRate qryMMOptionInstrCommRate,int requestId)
        {
            return CtpTraderNative.ReqQryMMOptionInstrCommRate(_instance, qryMMOptionInstrCommRate, requestId);
        }

        ///请求查询报单手续费
public int ReqQryInstrumentOrderCommRate(CtpQryInstrumentOrderCommRate qryInstrumentOrderCommRate,int requestId)
        {
            return CtpTraderNative.ReqQryInstrumentOrderCommRate(_instance, qryInstrumentOrderCommRate, requestId);
        }

        ///请求查询资金账户
public int ReqQrySecAgentTradingAccount(CtpQryTradingAccount qryTradingAccount,int requestId)
        {
            return CtpTraderNative.ReqQrySecAgentTradingAccount(_instance, qryTradingAccount, requestId);
        }

        ///请求查询二级代理商资金校验模式
public int ReqQrySecAgentCheckMode(CtpQrySecAgentCheckMode qrySecAgentCheckMode,int requestId)
        {
            return CtpTraderNative.ReqQrySecAgentCheckMode(_instance, qrySecAgentCheckMode, requestId);
        }

        ///请求查询二级代理商信息
public int ReqQrySecAgentTradeInfo(CtpQrySecAgentTradeInfo qrySecAgentTradeInfo,int requestId)
        {
            return CtpTraderNative.ReqQrySecAgentTradeInfo(_instance, qrySecAgentTradeInfo, requestId);
        }
...
public int ReqQryQuote(CtpQryQuote qryQuote,int requestId)
        ...
        ///请求查询期权自对冲
public int ReqQryOptionSelfClose(CtpQryOptionSelfClose qryOptionSelfClose,int requestId)
        {
            return CtpTraderNative.ReqQryOptionSelfClose(_instance, qryOptionSelfClose, requestId);
        }

        ///请求查询投资单元
public int ReqQryInvestUnit(CtpQryInvestUnit qryInvestUnit,int requestId)
        {
            return CtpTraderNative.ReqQryInvestUnit(_instance, qryInvestUnit, requestId);
        }
